...
mdl_Hippocampus_FWHM_AI <- lm(Hippocampus_FWHM_AI ~ Age_CurrentVisit+Sex_cat+Race_cat+Education_cat+FDG_SUVR_GTM_FS_Global+PiBStatus_SUVR_GTM_FS_Global+APOE_CODE, data = data)
